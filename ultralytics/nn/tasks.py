...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 BottleNeck_DCNv2_Dynamic, SPPD,nn.Conv2d,
                 C3_DCNv2, C2f_DCNv2, BasicBlock_DCNv2, BottleNeck_DCNv2, C3_DCNv3, C2f_DCNv3, BasicBlock_DCNv3,
                 BottleNeck_DCNv3,C2fCIB,ASPP,noASPP,KANConv2DLayer,SMPConv,ASPPdcnv3,ASPPdcnv4,ASPPkan,ASPPSMPConv,
                 C3_iRMB, C2f_iRMB, C3_iRMB_Cascaded, C2f_iRMB_Cascaded, C3_Attention, C2f_Attention, C3_Ortho,
                 C2f_Ortho, HWD,DCNvv4,PSA,SCDown,ASPP1,SPPELAN,SPPCSPC,HawkASPP,HawkASPP0,HawkASPPmul,
                 C3_DySnakeConv, C2f_DySnakeConv, DySnakeConv,HSPP,VSSASPP,
            ...
            if m in (HGBlock, Ghost_HGBlock, Rep_HGBlock, HGBlock_Attention):
                ...
                n = 1
        elif m is GradDynFPN:
            c1 = [ch[x] for x in f]
            c2 = args[0]

            args = [c1, *args]
        elif m in (noGradDynFPN,v3GradDynFPN,v4GradDynFPN,KanGradDynFPN,SMPGradDynFPN,HawkGradDynFPN,HawkGradDynFPN0,HawkGradDynFPNmul,HEGradDynFPN,VSSGradDynFPN):
            c1 = [ch[x] for x in f]
            c2 = args[0]
        ...
        #     args = [c1, args[0]]
            ...
            c2 = ch[f]
        elif m in {ASFF_2, ASFF_3,ASFF_3_FAM,ASFF_2_FAM}:
            c2 = args[0]
