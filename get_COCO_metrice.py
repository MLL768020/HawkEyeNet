...
def parse_opt():
    parser = argparse.ArgumentParser()
    parser.add_argument('--anno_json', type=str, default='/home/liyihang/miji/AI-TOD/annotations/instances_val2017.json', help='training model path')
    parser.add_argument('--pred_json', type=str, default='/home/liyihang/lyhredetr/runs/val/ta12/predictions.json', help='data yaml path')
