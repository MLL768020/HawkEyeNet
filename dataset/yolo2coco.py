...
parser.add_argument('--image_path', default='/home/liyihang/miji/AI-TOD/test/images/', type=str,
                    help="path of images")
parser.add_argument('--label_path', default='/home/liyihang/miji/AI-TOD/test/labels/', type=str,
                    help="path of labels .txt")
parser.add_argument('--save_path', type=str, default='/home/liyihang/miji/AI-TOD/annotations/instances_val2017.json',
